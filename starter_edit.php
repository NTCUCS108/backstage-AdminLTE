...
if($_POST['editor1']!='')
{
	...
	mysql_query("insert into edit_backstagehome value('$rs[0]','$rs[1]')");
    mysql_query("update backstagehome set backstageHome = '$_POST[editor1]',recent_edit_time = '$edittime'");
...
ob_start();                      // start capturing output
include('starter_edit_content.php');   // execute the file
$content = ob_get_contents();    // get the contents from the buffer
ob_end_clean();                  // stop buffering and discard contents
ob_start();                      // start capturing output
include('starter_edit_script.php');   // execute the file
