...
if($_POST['editor1']!='')
{
	...
	mysql_query("insert into edit_companyintroduce value('$rs[0]','$rs[1]')");
    mysql_query("update companyintroduce set companyIntroduce = '$_POST[editor1]',recent_edit_time = '$edittime'");
