...
{
	$data=mysql_query("select * from featurette where featurette_id = '$value'");
	...
	mysql_query("update featurette set featurette_id = '-1',img_src = '$deletepath[0]/delete_img/$deletepath[1]',dead_time = '$deletetime' where featurette_id='$rs[featurette_id]'");
}
}
...
include('Featurette_edit_header.php');   // execute the file
$header = ob_get_contents();    // get the contents from the buffer
ob_end_clean();                  // stop buffering and discard contents
ob_start();                      // start capturing output
include('Featurette_edit_content.php');   // execute the file
