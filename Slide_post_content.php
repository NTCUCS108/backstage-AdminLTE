...
<div class="box">
			...
			<?php
				...
				?>
				<?php if($_GET['use_original_pic']!="true")include("upload/upload_slide_pic.php");?><?php if(isset($check) and !isset($_SESSION['img_src'])) echo '<p style="color:red;">選擇圖片後請記得點上傳圖片</p>';?>
				<form method="post">
