...
foreach($delete as $value)
{
	...
	mysql_query("update page set dead_time = '$deletetime' where post_id = '$rs[post_id]'");
}
}
$data=mysql_query("select * from page where dead_time = '0000-00-00 00:00:00' order by create_time");
