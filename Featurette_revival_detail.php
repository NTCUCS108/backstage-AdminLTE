...
$data=mysql_query("select * from featurette where post_id = '$_GET[id]'");
$rs=mysql_fetch_assoc($data);
ob_start();                      // start capturing output
include('Featurette_revival_detail_header.php');   // execute the file
$header = ob_get_contents();    // get the contents from the buffer
ob_end_clean();                  // stop buffering and discard contents
ob_start();                      // start capturing output
include('Featurette_revival_detail_content.php');   // execute the file
