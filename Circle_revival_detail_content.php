...
<div class="box">
  ...
  <div class="col-md-offset-4 col-md-4">
    <p align="center">
      <button class="btn btn-primary" onclick="location.href = 'Circle_revival_browse.php';">回復活圈圈板</button><br>
    </p>
  </div>
  </div>
  ...
  <div class="col-md-offset-4 col-md-1">
      <a href="Circle_revival.php?id=<?php echo "$rs[post_id]"?>" class="btn btn-primary">復活</a>
  </div>
