...
else
{
	...
	if($type=="image/jpeg" or $type=="image/png" or $type=="image/gif")//副檔名審核
	{
		if($sizemb < MAX_UPLOAD)//限制流量為10MB
		{
			...
			move_uploaded_file($tmp_name,"../../bootstrap-3.3.1/docs/examples/carousel/img/featurette/".$name.".".$filename[1]);//搬移至想要的資料夾
			echo "上傳成功";
			$_SESSION['img_src'] = "../../bootstrap-3.3.1/docs/examples/carousel/img/featurette/$name.$filename[1]";
		}
		else
			echo "檔案必須小於10MB";
	}
