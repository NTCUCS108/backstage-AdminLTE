<ol class="breadcrumb">
					...
					<li class="active"><a href='http://ntcucsintern.ddns.net/backstage-AdminLTE/Featurette_edit_mode_select.php?id=<?php echo "$_GET[id]"?>'>編輯<?php echo "第$_GET[id]個列列中";?></a></li>
                </ol>